...
const opponent1 = new Hero("Loïc", 250, 650);
const opponent2 = new Hero("Guillaume", 180, 850);
const axe = new Weapon("Axe", 100);
const sword = new Weapon("Sword", 75);
...
const opponent3 = new HeroAxe("Garry", 3, 1600);
...
const opponent4 = new HeroSpear("Marcel", 1, 1000);
const opponent5 = new HeroSword("Antoine", 2, 2000);
// console.log(opponent3);
